                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="sm:-my-px sm:ms-10 sm:flex">
                                <form className="d-flex input-group h-10 p-3">
                                <input
                                    type="search"
                            ...
                            <div className="navbar gap-4 mx-5">
                                <NavLink className='nav-item mx-3'> <FontAwesomeIcon className='icon' icon={faHome} /></NavLink>
